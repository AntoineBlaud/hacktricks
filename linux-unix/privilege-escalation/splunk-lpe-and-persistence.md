...
![.gitbook/assets/1663787113.png](http://res.cloudinary.com/dr4gsg09f/image/upload/v1663787113/rnh4v8fyzk6pdsjom29b.png)
...
![.gitbook/assets/1663787114.png](http://res.cloudinary.com/dr4gsg09f/image/upload/v1663787114/iiytvwnddgpmdiobvkgb.png)

2- Receiving the /etc/passwd file on the attacker system through Netcat

![.gitbook/assets/1663787115.png](http://res.cloudinary.com/dr4gsg09f/image/upload/v1663787114/nizekaazw1o9drwh1ggf.png)

3- Requesting the /etc/shadow file through PySplunkWhisper2

![.gitbook/assets/1663787116.png](http://res.cloudinary.com/dr4gsg09f/image/upload/v1663787115/b56lp71bkpeyoowsxwi6.png)

4- Receiving the /etc/shadow file on the attacker system through Netcat

![.gitbook/assets/1663787117.png](http://res.cloudinary.com/dr4gsg09f/image/upload/v1663787117/lxhfatw1prymytappofn.png)

5- Adding the user attacker007 to the /etc/passwd file

![.gitbook/assets/1663787119.png](http://res.cloudinary.com/dr4gsg09f/image/upload/v1663787118/rjp6xpcmglgjqmwyal1d.png)

6- Adding the user attacker007 to the /etc/shadow file

![.gitbook/assets/1663787119.png](http://res.cloudinary.com/dr4gsg09f/image/upload/v1663787119/jayf1727ywy3uodgdcon.png)

7- Receiving the new /etc/shadow file showing attacker007 is successfully added

![.gitbook/assets/1663787120.png](http://res.cloudinary.com/dr4gsg09f/image/upload/v1663787119/drsdkq92evgauebekguh.png)

8- Confirming SSH access to the victim using the attacker007 account

![.gitbook/assets/1663787121.png](http://res.cloudinary.com/dr4gsg09f/image/upload/v1663787120/fn3zws6qnfbfwtjizjdl.png)

9- Adding a backdoor root account with username root007, with the uid/gid set to 0

![.gitbook/assets/1663787122.png](http://res.cloudinary.com/dr4gsg09f/image/upload/v1663787121/azfpj6jcyuy2exeb9afr.png)

10- Confirming SSH access using attacker007, and then escalating to root using root007

![.gitbook/assets/1663787123.png](http://res.cloudinary.com/dr4gsg09f/image/upload/v1663787123/v8b1qtk9gomzj2u4acyr.png)
