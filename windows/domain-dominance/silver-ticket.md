...
<<<<<<< HEAD:windows/active-directory-methodology/silver-ticket.md
{% content-ref url="dcsync.md" %}
[dcsync.md](dcsync.md)
=======
{% content-ref url="../active-directory-methodology/dcsync.md" %}
[dcsync.md](../active-directory-methodology/dcsync.md)
>>>>>>> master:windows/domain-dominance/silver-ticket.md
{% endcontent-ref %}
