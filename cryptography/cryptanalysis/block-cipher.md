...
The [data we can download](https://github.com/samvartaka/cryptanalysis/tree/master/five\_blocks/five\_blocks.zip) is named flag.enc and probably contains the target flag encrypted with some unknown key. The server code looks like this:
...
![.gitbook/assets/1663786961.png](http://res.cloudinary.com/dr4gsg09f/image/upload/v1663786961/gylx7ckqtltceegkmomb.png)
...
class bc1(object):
    ...
    def __init__(self, key_data):
        ...
        self.subkeys = [.gitbook/assets/1663786961.png]
...
![.gitbook/assets/1663786963.png](http://res.cloudinary.com/dr4gsg09f/image/upload/v1663786962/usujaosdkis9kuuh1o2l.png)
...
![.gitbook/assets/1663786964.png](http://res.cloudinary.com/dr4gsg09f/image/upload/v1663786963/ahoacg5dvacqfwbt3zea.png)
...
![.gitbook/assets/1663786961.png](http://res.cloudinary.com/dr4gsg09f/image/upload/v1663786963/n51ebcai7anssy4b3pmr.jpg)
...
![.gitbook/assets/1663786965.jpg](http://res.cloudinary.com/dr4gsg09f/image/upload/v1663786964/yac97w9gn1n4xrwk9fbk.jpg)
...
![.gitbook/assets/1663786966.jpg](http://res.cloudinary.com/dr4gsg09f/image/upload/v1663786965/bixudnn6evecjbsbl0az.jpg)
...
![.gitbook/assets/1663786967.png](http://res.cloudinary.com/dr4gsg09f/image/upload/v1663786966/tkfvffqogpuweoknnxq3.png)
...
```
valid_candidates = [.gitbook/assets/1663786961.png]
...
![.gitbook/assets/1663786967.png](http://res.cloudinary.com/dr4gsg09f/image/upload/v1663786966/vocunay2aj8ezt9dvkhq.png)
...
```
k0_candidates = [.gitbook/assets/1663786961.png]
k4_candidates = [.gitbook/assets/1663786961.png]
k5_candidates = [.gitbook/assets/1663786961.png]
...
def phase1(current_round, subkeys = [.gitbook/assets/1663786961.png], output_differential = 0, chosen_pairs = [.gitbook/assets/1663786961.png]):
    valid_candidates = [.gitbook/assets/1663786961.png]
    ...
    if (current_round == 0):
        ...
        if (len(candidate_roundkeys) == 0):
            ...
            return [.gitbook/assets/1663786961.png]
        else:
...
def phase2(candidate_schedules = [.gitbook/assets/1663786961.png], chosen_pairs = [.gitbook/assets/1663786961.png], multi = False):
    valid_schedules = [.gitbook/assets/1663786961.png]
...
def differential_cryptanalysis(output_differential, chosen_pairs):
    subkeys = [.gitbook/assets/1663786961.png]
...
![.gitbook/assets/1663786968.png](http://res.cloudinary.com/dr4gsg09f/image/upload/v1663786967/xdfpjmb3axf8krbrq8dd.png)
...
![.gitbook/assets/1663786969.png](http://res.cloudinary.com/dr4gsg09f/image/upload/v1663786968/xmhv7gd5xhpbkfda3trt.png)
