...
![aes\_base](.gitbook/assets/1663772247.png)
...
![aes\_decrypt](.gitbook/assets/1663772247.png)
...
![ecb1](.gitbook/assets/1663772248.png)
...
![ecb2](.gitbook/assets/1663772248.png)
...
![cbc1](.gitbook/assets/1663772248.png)
...
![cbc2](.gitbook/assets/1663772248.png)
...
![attack](.gitbook/assets/1663772248.png)
...
![GCM encryption operation](.gitbook/assets/1663772248.png)
...
![ECB encryption.svg](.gitbook/assets/1663772248.png)

![ECB decryption.svg](.gitbook/assets/1663772248.png)
...
![Cipher block chaining (CBC) mode encryption](.gitbook/assets/1663772249.png)

![Cipher block chaining (CBC) mode decryption](.gitbook/assets/1663772249.png)

If the first block has index 1, the mathematical formula for CBC encryption is

![{\displaystyle C\_{i}=E\_{K}(P\_{i}\oplus C\_{i-1}),}](.gitbook/assets/1663772249.svg/81d5dc659248a6ef5a9e7434250207da9ff3701e)

![{\displaystyle C\_{0}=IV,}](.gitbook/assets/1663772249.svg/3d4665e1c76ec310a9b8cda9d0597b4d5cbf5eba)

while the mathematical formula for CBC decryption is

![{\displaystyle P\_{i}=D\_{K}(C\_{i})\oplus C\_{i-1},}](.gitbook/assets/1663772249.svg/4d3f09299f92dca7d19e2a09c2611e797562855f)

![{\displaystyle C\_{0}=IV.}](.gitbook/assets/1663772249.svg/123befe3ec745ff58ed57c8c9ebd9ca866a3e390)

**Example**

![CBC example with a toy 2-bit cipher](.gitbook/assets/1663772250.png)
...
![Propagating cipher block chaining (PCBC) mode encryption](.gitbook/assets/1663772250.png)

![Propagating cipher block chaining (PCBC) mode decryption](.gitbook/assets/1663772250.png)

Encryption and decryption algorithms are as follows:

![{\displaystyle C\_{i}=E\_{K}(P\_{i}\oplus P\_{i-1}\oplus C\_{i-1}),P\_{0}\oplus C\_{0}=IV,}](.gitbook/assets/1663772249.svg/f24cd89847dc203b33ec1e56fa6a500eb13112b3)

![{\displaystyle P\_{i}=D\_{K}(C\_{i})\oplus P\_{i-1}\oplus C\_{i-1},P\_{0}\oplus C\_{0}=IV.}](.gitbook/assets/1663772249.svg/0339e988d88efe1a8cc49be93d94740a5a08da12)
...
![{\displaystyle {\begin{aligned}C\_{i}&={\begin{cases}{\text{IV)),\&i=0\E\_{K}(C\_{i-1})\oplus P\_{i},&{\text{otherwise))\end{cases))\P\_{i}&=E\_{K}(C\_{i-1})\oplus C\_{i},\end{aligned))}](.gitbook/assets/1663772249.svg/067d50816cc5b2282a73540cb0ea4d52b18c753f)

![CFB encryption.svg](.gitbook/assets/1663772251.png)

![CFB decryption.svg](.gitbook/assets/1663772251.png)
...
![{\displaystyle I\_{0}={\text{IV)).}](.gitbook/assets/1663772249.svg/89585f1821f70e464640e3494e159592dc4d3fa4)

![{\displaystyle I\_{i}={\big (}(I\_{i-1}\ll s)+C\_{i}{\big )}{\bmod {2))^{b},}](.gitbook/assets/1663772249.svg/f53045e4df0cbcc1b7b54d131c1f57953b3478fa)

![{\displaystyle C\_{i}=\operatorname {MSB} {s}{\big (}E{K}(I\_{i-1}){\big )}\oplus P\_{i},}](.gitbook/assets/1663772249.svg/4612fde7c98e80e5afb69859f07fdd745dfdaa5b)

![{\displaystyle P\_{i}=\operatorname {MSB} {s}{\big (}E{K}(I\_{i-1}){\big )}\oplus C\_{i},}](.gitbook/assets/1663772249.svg/3888352cc2d24d324f3c1ef6e508ed94b50490f8)
...
![{\displaystyle C\_{j}=P\_{j}\oplus O\_{j},}](.gitbook/assets/1663772249.svg/b63746b6542025fc42501be53993f3ed7efa10a0)

![{\displaystyle P\_{j}=C\_{j}\oplus O\_{j},}](.gitbook/assets/1663772249.svg/f04261d6197aebd02804b4831c1ae0743c7d6d4c)

![{\displaystyle O\_{j}=E\_{K}(I\_{j}),}](.gitbook/assets/1663772249.svg/a24c5536b9d8dd669e4b49372e4ca87b71629aff)

![{\displaystyle I\_{j}=O\_{j-1},}](.gitbook/assets/1663772249.svg/c2794ec975455d83e635b41a715d7feee3a0d4e2)

![{\displaystyle I\_{0}={\text{IV)).}](.gitbook/assets/1663772249.svg/89585f1821f70e464640e3494e159592dc4d3fa4)

![OFB encryption.svg](.gitbook/assets/1663772254.png)

![OFB decryption.svg](.gitbook/assets/1663772254.png)
...
![CTR encryption 2.svg](.gitbook/assets/1663772254.png)

![CTR decryption 2.svg](.gitbook/assets/1663772254.png)
